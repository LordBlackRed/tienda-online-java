...
<body>
	...
	<div id="main_container">
		...
		<div id="header">
			...
			<div id="logo">
				<a href="index.html"><img src="images/logo.png" alt="" title=""
		...
		<div id="main_content">
			...
			<div id="menu_tab">
				...
				<ul class="menu">
					...
					<li class="divider"></li>
					<li><a href="identificarse.jsp" class="nav4">Sign Up</a></li>
					<li class="divider"></li>
					...
					<c:choose>
						<c:when test="${sessionScope.usuario.admin == true}">
							...
							<li><a href="#" class="nav2">Administrar</a></li>
							<li class="divider"></li>
			...
			<div class="left_content">
				...
				<ul class="left_menu">
					...
					<li class="even"><a href="services.html">Laptops &
							Notebooks</a></li>
					<li class="odd"><a href="services.html">Processors</a></li>
					<li class="even"><a href="services.html">Motherboards</a></li>
					<li class="odd"><a href="services.html">Processors</a></li>
				...
				<div class="banner_adds">
					...
					<a href="#"><img src="images/bann2.jpg" alt="" title=""
						border="0" /></a>
				</div>
			...
			<div class="center_content">
				...
				<form action="ProductoNuevo" method="post">
					<label for="nombre">Nombre: </label><input type="text"
						...
						<c:forEach items="${requestScoppe.categorias}" var="categoria">
			...
			<div class="right_content">
				<div class="shopping_cart">
					...
					<c:choose>
						...
						<c:otherwise>Sesion: ${sessionScope.usuario.nombre}
						</c:otherwise>
					</c:choose>
				...
				<div class="banner_adds">
					...
					<a href="#"><img src="images/bann1.jpg" alt="" title=""
						border="0" /></a>
				</div>
