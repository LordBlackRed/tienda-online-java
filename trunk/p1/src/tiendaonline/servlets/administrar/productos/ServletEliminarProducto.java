	...
	protected void doGet(HttpServletRequest request,
		...
		for (Producto producto: productos){
			if (producto.getId().getId() == Long.parseLong(idProducto)){
				//Boramos cualquier rastro de ese producto en otros lugares, como los fav en usuario
				//Al estar subido en GAE no podemos usar la t’pica acci—n de eliminaci—n en Cascada, aunque el GAE s’ te trae esa opci—n es demasiado limitada para nuestro objetivo
